...
\item \textbf{Lecture 13:} More raw context is not always better. Long-horizon agents need compact state, tool feedback, and goal tracking, not just a larger prompt.
