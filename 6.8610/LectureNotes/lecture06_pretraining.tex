...
\begin{itemize}
    ...
    \item \textbf{Synthetic fine-tuning data:} use a stronger model to generate question-answer (QA) pairs, instructions, or additional domain documents when human-labeled data is scarce.
...
\textbf{Transfer-learning pipeline.} Let \(D_{\mathrm{PT}}\) be a pretraining (PT) corpus and \(D_{\mathrm{FT}}\) a fine-tuning (FT) downstream dataset. A standard abstraction is
\[
\theta_{\mathrm{PT}}
=
