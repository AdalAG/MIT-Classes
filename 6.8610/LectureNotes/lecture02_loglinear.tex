...
\textbf{Term frequency-inverse document frequency (TF-IDF).} The lecture motivates downweighting common function words. Here \(\operatorname{TF}\) denotes term frequency and \(\operatorname{IDF}\) inverse document frequency.
\[
...
\textbf{Continuous bag-of-words (CBOW) model.} Predict a target word from a set of context words:
\[
...
\textbf{Pointwise mutual information (PMI) connection.} For skip-gram and related embedding schemes, the learned embeddings approximately satisfy
\[
