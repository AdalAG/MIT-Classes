...
\begin{itemize}
    ...
    \item \textbf{Formal metrics:} use automatic functions such as perplexity, BLEU, ROUGE, or BERTScore to compare predictions with references.
...
\]
The standard BLEU score combines multiple \emph{n}-gram precisions with a brevity penalty:
\[
\operatorname{BLEU}
=
...
\begin{itemize}
    ...
    \item \textbf{SuperGLUE and Humanity's Last Exam:} benchmark examples showing the appeal of forced-choice evaluation and the dangers of overfitting to one public evaluation set.
